...
<body onload="document.registration.empid.focus();" background="background.jpg">
<td>
...
<td><form action="Applicant.php" method="post"><input type="submit" value="View-Applicant" id="form"></form></td>
</tr>
</table>
</body>
</html>